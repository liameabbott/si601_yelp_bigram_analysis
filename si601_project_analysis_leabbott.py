...
def bigram_counter(reviews):
    ...
    #Using itertools groupby() function, count occurences of each bigram in the
    #sorted bigram list created above.
    bigram_counts_list = []
...
#number of occurrences of each bigram divided by the total number of bigrams in
#all positive reviews. Do the same for negative bigrams.
...
#Create a tab-delimited .txt file with list of bigrams, counts, probabilities
#found in negative reviews, sorted by most frequently occuring.         
